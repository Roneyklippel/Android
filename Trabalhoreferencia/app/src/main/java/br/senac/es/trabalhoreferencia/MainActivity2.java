...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mensagem novaMensagem1 = new Mensagem(1L, "Roney", Status.ENVIADA);
        Mensagem novaMensagem2 = new Mensagem(2L, "Jose", Status.NAOENVIADA);
        Mensagem novaMensagem3 = new Mensagem(3L, "Fabio", Status.ENVIADA);
        Mensagem novaMensagem4 = new Mensagem(4L, "Marciano", Status.ENVIADA);
        Mensagem novaMensagem5 = new Mensagem(5L, "Rhapael", Status.NAOENVIADA);
        Mensagem novaMensagem6 = new Mensagem(6L, "Henrique", Status.NAOENVIADA);
